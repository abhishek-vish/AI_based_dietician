'''
this is ai based dietician project source code
...
a = Tk()
a.title('Smart Dietician')
img = tkinter.PhotoImage(file = "C:/Users/abhi/Downloads/logo.gif")
a.iconphoto(a,img)
a.geometry("1100x300")
...
l1 = Label(a, text='Weight',bg  = 'pale green')
l2 = Label(a, text='Height(in cms)',bg = 'pale green')
l3 = Label(a, text='Age  ',bg = '#ff99cc')
l4 = Label(a, text = 'Gender', bg = 'pale green')
l5 = Label(a, text = 'Activity', bg = 'pale green')
l7 = Label(a, text = '')
...
b1 = Button(a, text = 'Submit', bg = 'LightSkyBlue1', width=20, command = BMR, fg = 'brown')
